...
const DocDataset = () => {
    return(
        <div className='documentation'>
            ...
            <img width="700px"  alt="Upset plot showing cell lines tested on different datasets" src={upsetPlot} title="Datasets Upset plot" />
            ...
            <img width="75%" alt="List of datasets" src={datasetList} title="List of datasets"/><br/>
            ...
            <img width="75%" alt="Intial view of individual dataset page" src={individualDataset} title="Dataset page"/><br/>
            <h7>Resources</h7><br/>
            <p>Resources page includes links to resources which provide access to the original data.</p>
            <img width="280px" alt="Resource section of individual dataset page" src={datasetResource} title="Dataset resources"/><br/>
            <h7>Data Types</h7>
            ...
            <img width="600px" alt="Data type table" src={dataTypes} title="Data types"/><br/>
            <h7>Bar Plots</h7>
            ...
            <img width="600px" alt="Bar plots" src={datasetBarPlotB} title="Tests accross datasets"/><br/>
            ...
            <img width="600px" alt="List of cell lines tested in dataset" src={datasetCellList} title="Cell lines"/><br/>
