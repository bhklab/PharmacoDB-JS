    ...
    return(
        <div className='documentation'>
            <div>
                ...
                <img height="auto" width="650px"  alt="screenshot of searching tissue/drug pair" className="documentation" src={doseImg} title="Searching tissue/drug pair" />
                <p>
                ...
                <img height="auto" width="650px"  alt="screenshot of tissue/drug pair page" className="documentation" src={doseImg} title="Tissue/drug pair" />
            </div>
        </div>
    );
}
