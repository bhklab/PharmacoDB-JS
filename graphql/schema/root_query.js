...
const RootQuery = `type RootQuery {
    ...
    gene_compound_tissue_dataset(geneId: Int, compoundId: Int, tissueId: Int, geneName: String, compoundName: String, tissueName: String, page: Int, per_page: Int, all: Boolean): [GeneCompoundTissueDataset!]!
