...
const test = (server) => {
    ...
    it('Data coming from gene_drugs API route contains all experimental data for a single gene along with detailed information about dataset, tissue, gene and compound', done => { 
        request(server)
            .post('/graphql')
